...
<head>
    ...
    <link href="<?php echo base_url(); ?>public/assets/plugins/bootstrap-tagsinput/dist/bootstrap-tagsinput.css" rel="stylesheet" />
    <link href="<?php echo base_url(); ?>public/assets/plugins/bootstrap-touchspin/dist/jquery.bootstrap-touchspin.min.css" rel="stylesheet" />
    <!-- Custom CSS -->
...
<body class="fix-header card-no-border">
            ...
            <div class="container-fluid">
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <h5 class="mt-3">Multiple select boxes</h5>
                                <select class="select2 mb-2 select2-multiple" style="width: 100%" multiple="multiple" data-placeholder="Choose">
                                    <optgroup label="Alaskan/Hawaiian Time Zone">
                                        <option value="AK">Alaska</option>
                                        <option value="HI">Hawaii</option>
                                    </optgroup>
                            ...
                            <div class="card-body">
                                ...
                                <div class="row">
                                    <div class="col-lg-4 col-md-6">
                                        <h5 class="mt-4 mb-2">Select box</h5>
                                    ...
                                    <div class="col-lg-4 col-md-6">
                                        <h5 class="mt-4 mb-2">Select boxes with optgroups</h5>
                                        <select class="selectpicker" data-style="form-control btn-secondary">
                                    ...
                                    <div class="col-lg-4 col-md-6">
                                        <h5 class="mt-4">Multiple select boxes</h5>
                                ...
                                <h5 class="mt-4">With colored Button Classes</h5>
                                <div class="row">
                                    <div class="col-lg-4 col-md-6">
                                        <select class="selectpicker mb-3 mr-2" data-style="btn-primary">
                                    ...
                                    <div class="col-lg-4 col-md-6">
                                        <select class="selectpicker mb-3 mr-2" data-style="btn-warning ">
                                            <option data-tokens="ketchup mustard">Hot Dog, Fries and a Soda</option>
                                            <option data-tokens="mustard">Burger, Shake and a Smile</option>
                                            <option data-tokens="frosting">Sugar, Spice and all things nice</option>
                                        </select>
                                    ...
                                    <div class="col-lg-4 col-md-6">
                                        <select class="selectpicker mb-3 mr-2" data-style="btn-danger">
                                            <option data-tokens="ketchup mustard">Hot Dog, Fries and a Soda</option>
                                            <option data-tokens="mustard">Burger, Shake and a Smile</option>
                                            <option data-tokens="frosting">Sugar, Spice and all things nice</option>
                                        </select>
                                    ...
                                    <div class="col-lg-4 col-md-6">
                                        <select class="selectpicker mb-3 mr-2" data-style="btn-success">
                                            <option data-tokens="ketchup mustard">Hot Dog, Fries and a Soda</option>
                                            <option data-tokens="mustard">Burger, Shake and a Smile</option>
                                            <option data-tokens="frosting">Sugar, Spice and all things nice</option>
                                        </select>
                                    ...
                                    <div class="col-lg-4 col-md-6">
                                        <select class="selectpicker mb-3" data-style="btn-default">
                                            <option data-tokens="ketchup mustard">Hot Dog, Fries and a Soda</option>
                                            <option data-tokens="mustard">Burger, Shake and a Smile</option>
                                            <option data-tokens="frosting">Sugar, Spice and all things nice</option>
                                        </select>
                                ...
                                <div class="row">
                                    <div class="col-lg-12">
                                        ...
                                        <div class="switchery-demo mb-4">
                                            ...
                                            <input type="checkbox" checked class="js-switch" data-color="#55ce63" />
                                    ...
                                    <div class="col-lg-12">
                                        ...
                                        <div class="mb-4">
                                            <input type="checkbox" class="js-switch" data-color="#55ce63" data-secondary-color="#f62d51" />
                    ...
                    <div class="col-lg-6 col-md-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <h4 class="card-title mt-4">Select Tags</h4>
                                ...
                                <h4 class="card-title  mt-4">Input Group Tags</h4>
                                <h6 class="card-subtitle">You can also use group tag <code>data-role="tagsinput"</code> to your input field.</h6>
                                <div class="input-group  mt-3 mb-4"> <span class="input-group-addon">Tags</span>
                                    <input type="text" value="Amsterdam,Washington,Sydney" data-role="tagsinput" placeholder="add tags"> </div>
                            ...
                            <div class="card-body">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-12 col-xlg-4">
                                        ...
                                        <div class="button-box mt-3"> <a id="select-all" class="btn btn-danger" href="#">select all</a> <a id="deselect-all" class="btn btn-info" href="#">deselect all</a> <a id="add-option" class="btn btn-success" href="#">Add option</a> <a id="refresh" class="btn btn-warning" href="#">refresh</a> </div>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">Checkbox and radio button</h4>
                                <h6 class="card-subtitle"> Use a <code>&lt;div class="checkbox"&gt; &lt;input id="checkbox0" type="checkbox"&gt;&lt;label for="checkbox0"&gt; Default &lt;/label&gt;&lt;/div&gt;</code> as your input element.</h6>
                                <div class="row">
                                    <div class="col-xlg-2 col-lg-4 col-md-6 col-xs-12">
                                        <h4 class="card-title mt-5">Checkbox Square</h4>
                                        <h6 class="card-subtitle mb-4"> Bootstrap brand colors </h6>
                                        <div class="checkbox">
                                    ...
                                    <div class="col-xlg-2 col-lg-4 col-md-6 col-xs-12">
                                        <h4 class="card-title mt-5">Checkbox Circle</h4>
                                        <h6 class="card-subtitle mb-4">Add simple <code>checkbox-circle</code> class </h6>
                                    ...
                                    <div class="col-xlg-2 col-lg-4 col-md-6 col-xs-12">
                                        <h4 class="card-title mt-5">Checkbox Disable</h4>
                                        <h6 class="card-subtitle mb-4"> Disable state </h6>
                                        <div class="checkbox">
                                    ...
                                    <div class="col-xlg-2 col-lg-4 col-md-6 col-xs-12">
                                        <h4 class="card-title mt-5">Radio Buttons</h4>
                                        <h6 class="card-subtitle mb-4"> With bootstrap colors </h6>
                                        <div class="radio">
                                    ...
                                    <div class="col-xlg-2 col-lg-4 col-md-6 col-xs-12">
                                        <h4 class="card-title mt-5">Radio Clickable</h4>
                                        <h6 class="card-subtitle mb-4"> All buttons clickable </h6>
                                        <div class="radio">
                                    ...
                                    <div class="col-xlg-2 col-lg-4 col-md-6 col-xs-12">
                                        <h4 class="card-title mt-5">Radio Disable</h4>
                                        <h6 class="card-subtitle mb-4"> Disable state </h6>
                                        <div class="radio">
    ...
    <script src="<?php echo base_url(); ?>public/assets/plugins/bootstrap-tagsinput/dist/bootstrap-tagsinput.min.js"></script>
    <script src="<?php echo base_url(); ?>public/assets/plugins/bootstrap-touchspin/dist/jquery.bootstrap-touchspin.js" type="text/javascript"></script>
