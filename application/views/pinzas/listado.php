...
<div id="myModal" class="modal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
	<div class="modal-dialog">
		<div class="modal-content">
			...
			<?php echo form_open('pinzas/guarda'); ?>
				<div class="modal-header">
					<h4 class="modal-title" id="myModalLabel">FORMULARIO DE PINZAS</h4>
				...
				<div class="modal-footer">
					<button type="submit" class="btn waves-effect waves-light btn-block btn-success">GUARDA PINZA</button>
				</div>
			</form>
			...
			<div class="col-12">
				...
				<div class="card">
					<div class="card-body">
						...
						<h3 class="card-title">LISTADO DE PINZAS &nbsp;&nbsp;&nbsp;&nbsp; 
							<button type="button" class="btn btn-info" onclick="abre_modal();"><i class="fas fa-plus"></i> NUEVA PINZA</button></h3>
							...
							<table id="config-table" class="table display table-bordered table-striped no-wrap">
								...
								<tbody>
									...
									<tr>
										...
										<td>
											<button type="button" class="btn btn-warning" onclick="editar(<?php echo $p['id'] ?>, '<?php echo $p['nombre'] ?>', '<?php echo $p['tipo'] ?>', '<?php echo $p['genero'] ?>')"><i class="fas fa-edit"></i></button>
	...
	function eliminar(id, nombre) {
		...
		Swal.fire({
			...
			if (result.value) {
				...
				window.location.href = "<?php echo base_url() ?>pinzas/eliminar/" + id;
			}
		})
	}
