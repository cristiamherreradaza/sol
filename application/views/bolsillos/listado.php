		...
		<div class="modal-content">
			...
			<?php echo form_open('bolsillos/guarda'); ?>
				...
				<div class="modal-footer">
					<button type="submit" class="btn waves-effect waves-light btn-block btn-success">GUARDA BOLSILLO</button>
				</div>
			</form>
			...
			<div class="col-12">
				...
				<div class="card">
					<div class="card-body">
						...
						<h3 class="card-title">LISTADO DE BOLSILLOS &nbsp;&nbsp;&nbsp;&nbsp; 
							<button type="button" class="btn btn-info" onclick="abre_modal();"><i class="fas fa-plus"></i> NUEVO BOLSILLO</button></h3>
							...
							<table id="config-table" class="table display table-bordered table-striped no-wrap">
								...
								<tbody>
									...
									<tr>
										...
										<td>
											<button type="button" class="btn btn-warning" onclick="editar(<?php echo $b['id'] ?>, '<?php echo $b['nombre'] ?>', '<?php echo $b['tipo'] ?>', '<?php echo $b['genero'] ?>')"><i class="fas fa-edit"></i></button>
											<button type="button" class="btn btn-danger" onclick="eliminar(<?php echo $b['id'] ?>, '<?php echo $b['nombre'] ?>')"><i class="fas fa-trash"></i></button>
										</td>
									</tr>
									<?php endforeach ?>
								</tbody>
	...
	function eliminar(id, nombre) {
		...
		Swal.fire({
			...
			if (result.value) {
				...
				window.location.href = "<?php echo base_url() ?>bolsillos/eliminar/" + id;
			}
		})
	}
