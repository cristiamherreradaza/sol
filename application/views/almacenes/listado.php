...
<div id="myModal" class="modal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
	<div class="modal-dialog modal-lg">
		<div class="modal-content">
			...
			<?php 
                $attributes = array('method'=>'POST', 'id' => 'formulario-almacen');
				echo form_open('Almacen/guarda', $attributes); 
			?>
				<div class="modal-header">
					<h4 class="modal-title" id="myModalLabel">FORMULARIO DE ALMACEN</h4>
				...
				<div class="modal-footer">
					<button type="button" onclick="guardarabertura()" class="btn waves-effect waves-light btn-block btn-success">GUARDA ALMACEN</button>
				</div>
			</form>
			...
			<div class="col-12">
				...
				<div class="card">
					<div class="card-body">
						...
						<h3 class="card-title">LISTADO DE ALMACENES &nbsp;&nbsp;&nbsp;&nbsp; 
							<button type="button" class="btn btn-info" onclick="abre_modal();"><i class="fas fa-plus"></i> NUEVA ALMACEN</button>
						</h3>
							...
							<table id="config-table" class="table display table-bordered table-striped no-wrap">
								...
								<tbody>
									...
									<tr>
										...
										<td><?php echo $a['telefonos'] ?></td>
										<td>
											<button type="button" class="btn btn-warning" onclick="editar(<?php echo $a['id'] ?>, '<?php echo $a['nombre'] ?>', '<?php echo $a['direccion'] ?>', '<?php echo $a['telefonos'] ?>')"><i class="fas fa-edit"></i></button>
...
<script>
	...
	function guardarabertura(){
		if($('#formulario-almacen')[0].checkValidity()){
			$('#formulario-almacen').submit();
            Swal.fire("Excelente!", "Registro Guardado!", "success");
        }else{
            $('#formulario-almacen')[0].reportValidity()
        }
	}
	...
	function eliminar(id, nombre) {
		...
		Swal.fire({
			...
			if (result.value) {
				...
				window.location.href = "<?php echo base_url() ?>Almacen/eliminar/" + id;
			}
		})
	}
</script>