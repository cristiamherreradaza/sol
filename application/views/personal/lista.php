								...
								<tbody>
									...
									<tr>
										...
										<td>
                                            ...
                                            <button type="button" class="btn btn-warning" onclick="editar(<?php echo $per->id ?>, '<?php echo $per->nombre ?>', '<?php echo $per->carnet ?>', '<?php echo $per->direccion ?>', '<?php echo $per->celulares ?>', '<?php echo $per->fecha_ingreso ?>', '<?php echo $per->sueldo ?>')"><i class="fas fa-edit"></i></button>
...
<script type="text/javascript">
	function editar(id, nombre, carnet, direccion, celulares, fecha_ingreso, sueldo)
    {
