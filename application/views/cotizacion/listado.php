			...
			<div class="col-12">
				...
				<div class="card">
                    <div class="card-body">
                    	...
                    	<h2 class="modal-title" id="myModalLabel">COTIZACI&Oacute;N</h2>
                    		<!-- <form class="form"> -->
                    	...
                    	<!-- <div class="form-row">
                            ...
                            <div class="col-md-3 mb-3">
                                <label for="validationCustom03">Telas</label>
                                    <select class="form-control custom-select" data-style="btn-primary" id="id2" name="id2"  />
                            ...
                            <div class="col-md-3 mb-3">
                                <label for="validationCustom03">Telas</label>
                                    <select class="form-control custom-select" data-style="btn-primary" id="id3" name="id3"  />
                                        <option>Seleccionar una Tela</option>
                                    <?php foreach($telas as $te){ ?>
                                        <option value="<?php echo $te->id; ?>"><?php echo $te->nombre; ?> <?php echo $te->precio; ?> Bs.</option>
                                    <?php } ?>
							...
							<table id="config-table" class="table display table-bordered table-striped no-wrap">
									...
									<tr>
										...
										<th>
											<div class="col-md-10 mb-3">
				                                    <select class="form-control custom-select" data-style="btn-primary" id="id1" name="id1"  />
				                                        <option>Seleccionar una Tela</option>
				                                    <?php foreach($telas as $te){ ?>
				                                        <option value="<?php echo $te->id; ?>"><?php echo $te->nombre; ?> <?php echo $te->precio; ?> Bs.</option>
				                                    <?php } ?>
								...
								<tbody>
									<tr>
										...
										<td><input type="text" id="pre_1" name="pre_1"> Bs.</td>
										<td><input type="text" id="pre_2" name="pre_2"> Bs.</td>
										<td><input type="text" id="pre_3" name="pre_3"> Bs.</td>
									</tr>
									<tr>
										<td>3</td>
										<td>Saco, Pantalon y Chaleco</td>
										<td><input type="text" id="pre_4" name="pre_4"> Bs.</td>
										<td><input type="text" id="pre_5" name="pre_5"> Bs.</td>
										<td><input type="text" id="pre_6" name="pre_6"> Bs.</td>
									</tr>
								</tbody>
							</table>
						</div>
							...
							<table id="config-table" class="table display table-bordered table-striped no-wrap">
								<thead>
									<tr>
										...
										<th>
											<div class="col-md-10 mb-3">
				                                    <select class="form-control custom-select" data-style="btn-primary" id="id4" name="id4" />
				                                        <option>Seleccionar una Tela</option>
				                                    <?php foreach($telas as $te){ ?>
										...
										<th>
											<div class="col-md-10 mb-3">
				                                    <select class="form-control custom-select" data-style="btn-primary" id="id5" name="id5"  />
				                                        <option>Seleccionar una Tela</option>
				                                    <?php foreach($telas as $te){ ?>
				                                        <option value="<?php echo $te->id; ?>"><?php echo $te->nombre; ?> <?php echo $te->precio; ?> Bs.</option>
				                                    <?php } ?>
										...
										<th>
											<div class="col-md-10 mb-3">
				                                    <select class="form-control custom-select" data-style="btn-primary" id="id6" name="id6"  />
				                                        <option>Seleccionar una Tela</option>
				                                    <?php foreach($telas as $te){ ?>
				                                        <option value="<?php echo $te->id; ?>"><?php echo $te->nombre; ?> <?php echo $te->precio; ?> Bs.</option>
				                                    <?php } ?>
								...
								<tbody>
									<tr>
										<td>2</td>
										<td>Saco y Pantalon</td>
										<td><input type="text" id="pre_7" name="pre_7"> Bs.</td>
										<td><input type="text" id="pre_8" name="pre_8"> Bs.</td>
										<td><input type="text" id="pre_9" name="pre_9"> Bs.</td>
									</tr>
									<tr>
										<td>3</td>
										<td>Saco, Pantalon y Falda</td>
										<td><input type="text" id="prec_1" name="prec_1"> Bs.</td>
										<td><input type="text" id="prec_2" name="prec_2"> Bs.</td>
										<td><input type="text" id="prec_3" name="prec_3"> Bs.</td>
									</tr>
								</tbody>
							</table>
						</div>
