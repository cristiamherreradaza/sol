...
<div id="myModal" class="modal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
	<div class="modal-dialog">
		<div class="modal-content">
			...
			<?php echo form_open('detalles/guarda'); ?>
				...
				<div class="modal-footer">
					<button type="submit" class="btn waves-effect waves-light btn-block btn-success">GUARDA DETALLE</button>
				</div>
			</form>
			...
			<div class="col-12">
				...
				<div class="card">
					<div class="card-body">
						...
						<h3 class="card-title">LISTADO DETALLES &nbsp;&nbsp;&nbsp;&nbsp; 
							<button type="button" class="btn btn-info" onclick="abre_modal();"><i class="fas fa-plus"></i> NUEVO DETALLE</button></h3>
							...
							<table id="config-table" class="table display table-bordered table-striped no-wrap">
								...
								<tbody>
									...
									<tr>
										...
										<td>
											<button type="button" class="btn btn-warning" onclick="editar(<?php echo $d['id'] ?>, '<?php echo $d['nombre'] ?>', '<?php echo $d['tipo'] ?>', '<?php echo $d['genero'] ?>')"><i class="fas fa-edit"></i></button>
											<button type="button" class="btn btn-danger" onclick="eliminar(<?php echo $d['id'] ?>, '<?php echo $d['nombre'] ?>')"><i class="fas fa-trash"></i></button>
										</td>
									</tr>
									<?php endforeach ?>
								</tbody>
	...
	function eliminar(id, nombre) {
		...
		Swal.fire({
			...
			if (result.value) {
				...
				window.location.href = "<?php echo base_url() ?>detalles/eliminar/" + id;
			}
		})
	}
