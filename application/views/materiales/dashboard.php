            ...
            <div class="card card-inverse card-dark">
                <div class="card-body">
                    ...
                    <div class="text-right">
                        <h2 class="font-light mb-0 text-white"><i class="ti-arrow-up text-success"></i> $120</h2>
                        <span class="text-white">Todays Income</span>
                    </div>
        ...
        <div class="col-lg-3 col-md-6">
            <div class="card card-inverse card-warning">
                <div class="card-body">
                    ...
                    <div class="text-right">
                        <h2 class="font-light mb-0  text-white"><i class="ti-arrow-up text-info"></i> $5,000</h2>
                        <span class="text-white">Todays Income</span>
                    </div>
        ...
        <div class="col-lg-3 col-md-6">
            <div class="card card-inverse card-success">
                <div class="card-body">
                    ...
                    <div class="text-right">
                        <h2 class="font-light mb-0  text-white"><i class="ti-arrow-up text-purple"></i> $8,000</h2>
                        <span class="text-white">Todays Income</span>
                    </div>
        ...
        <div class="col-lg-3 col-md-6">
            <div class="card card-inverse card-info">
                <div class="card-body">
                    ...
                    <div class="text-right">
                        <h2 class="font-light mb-0  text-white"><i class="ti-arrow-down text-dark"></i> $12,000</h2>
                        <span class="text-white">Todays Income</span>
                    </div>
                    <span class="text-dark">80%</span>
                    <div class="progress">
                        <div class="progress-bar bg-dark" role="progressbar" style="width: 80%; height: 6px;" aria-valuenow="25" aria-valuemin="0" aria-valuemax="100"></div>
                    </div>
                </div>
            </div>
        </div>
